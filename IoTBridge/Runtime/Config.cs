...
namespace Horeich.IoTBridge.Runtime
{
    ...
    public class Config : IConfig
    {
        ...
        private const string STORAGE_DEVICE_COLLECTION_KEY = STORAGE_KEY + "DeviceContainerId";
        private const string STORAGE_MAPPING_COLLECTION_KEY = STORAGE_KEY + "MappingContainerId";
